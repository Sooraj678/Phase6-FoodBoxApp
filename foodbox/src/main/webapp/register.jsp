...
<div class="container-fluid">
		...
		<form action="RegisterCtl" method="post">
						...
						<div class="form-group">
							<label for="email" style="color:black!important;"><b>User Email-Id</b></label> 
						...
						<div class="form-group">
							<label for="password" style="color:black!important;"><b>User Password</b></label> 
						...
						<div class="form-group">
							<label for="phone" style="color:black!important;"><b>User Phone</b></label> 
						...
						<div class="form-group">
							<label for="phone" style="color:black!important;"><b>User Address</b></label>
