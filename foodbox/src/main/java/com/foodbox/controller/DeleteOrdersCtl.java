	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			st.executeUpdate("delete from purchasedrecord where purchase_UserEmail = '"+orderedEmail+"'  ");
			 ...
			 httpSession.setAttribute("message", "Your Order records got deleted Successfully..!! Please remove your selected Items from Your cart and  User Email is: " +orderedEmail);
